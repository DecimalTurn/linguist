module Linguist
  class Generated
    ...
    # Internal: Is this a VBAX type file?
    # *.d.vb files are generated by the XVBA VS Code extension for providing intellisense.
    #
    # Returns true or false
    def generated_vbax?
      return false unless name.downcase.end_with?('.d.vb')
      return lines[0..9].any? { |line| line.include?("'/*") }
    end
